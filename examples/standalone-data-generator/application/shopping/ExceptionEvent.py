...
main_exception_rate = WeightedArray([(True, 6), (False, 1000)])
category_exception_rate = WeightedArray([(True, 1), (False, 1000)])
search_exception_rate = WeightedArray([(True, 1), (False, 1000)])
detail_exception_rate = WeightedArray([(True, 8), (False, 1000)])
cart_exception_rate = WeightedArray([(True, 4), (False, 1000)])
checkout_exception_rate = WeightedArray([(True, 1), (False, 1000)])
result_exception_rate = WeightedArray([(True, 1), (False, 1000)])
profile_exception_rate = WeightedArray([(True, 1), (False, 1000)])
