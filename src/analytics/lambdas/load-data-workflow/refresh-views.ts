...
import { CLICKSTREAM_ACQUISITION_DAY_USER_VIEW_CNT_MV, CLICKSTREAM_EVENT_VIEW_NAME, CLICKSTREAM_LIFECYCLE_VIEW_NAME, CLICKSTREAM_RETENTION_BASE_VIEW_NAME, CLICKSTREAM_SESSION_M_MAX_VIEW_NAME, CLICKSTREAM_SESSION_M_VIEW_NAME, CLICKSTREAM_USER_M_MAX_VIEW_NAME, CLICKSTREAM_USER_M_VIEW_NAME } from '@aws/clickstream-base-lib';
