CREATE TABLE IF NOT EXISTS {{database_name}}.{{schema}}.{{viewName}} (
  ...
  event_time_msec bigint,
  event_name varchar(255),
  user_pseudo_id varchar(255),
  user_id varchar(255),
  session_id varchar(255),
  event_value double precision ENCODE raw,
  ...
  device_time_zone_offset_seconds integer,
  ...
  device_ua_string varchar(65535),
  ...
  screen_view_entrances varchar(5),
  ...
  page_view_entrances varchar(5),
  app_start_is_first_time varchar(5),
  ...
  view_session_indicator varchar(255),
  view_event_indicator varchar(255)
)
BACKUP YES
