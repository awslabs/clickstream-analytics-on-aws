...
CASE
                    ...
                    p.value.set_timestamp_micros::bigint
                )
            ) user_props
        FROM
            user_props_exploded
...
SET
    ...
    user_properties_json_str = t.user_props_json_str,
...
WHERE
    user_v2.user_pseudo_id = t.user_pseudo_id GET DIAGNOSTICS record_number := ROW_COUNT;
