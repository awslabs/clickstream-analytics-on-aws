...
type UserSegmentFilterCondition = UserEventCondition | EventsInSequenceCondition | UserAttributeCondition | UserInSegmentCondition;
...
interface EventWithParameter {
  eventName: string;
  eventParameterCondition?: ParameterCondition;
}
