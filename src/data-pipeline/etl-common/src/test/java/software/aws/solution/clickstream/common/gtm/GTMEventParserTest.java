...
public class GTMEventParserTest extends BaseTest {
    ...
    void test_gtm_ingestLineToRow() throws IOException {
        ...
        ClickstreamIngestRow row = GTMEventParser.getInstance(getTransformConfig("test", true)).ingestLineToRow(firstLine);
    ...
    void test_gtm_ingestDataToEvent() throws IOException {
        ...
        GTMEventParser gtmEventParser = GTMEventParser.getInstance(getTransformConfig("test", true));
    ...
    void testParseJsonInvalidSessionNumber() throws JsonProcessingException {
        ...
        GTMEventParser eventParser = GTMEventParser.getInstance(null);
