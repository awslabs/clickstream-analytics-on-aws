...
public class DefaultTrafficSourceHelperTest {
    ...
    void testParse() throws URISyntaxException, JsonProcessingException {
        ...
        Assertions.assertEquals("{utm_id=campaignId, utm_term=term, utm_source_platform=clidPlatform, xclid=xcidxxxx, utm_campaign=campaign, utm_medium=medium, utm_content=content, utm_source=source}",
    ...
    void testParseWithReferrer() throws URISyntaxException, JsonProcessingException {
        ...
        Assertions.assertEquals("{bih=667, ei=0f8yU5r6E8mSyAGFhoGwDw, hl=en, utm_campaign=campaign, utm_medium=medium, " +
                        "source=lnms, sa=X, utm_id=campaignId, utm_term=term, biw=1366, q=flowers,food, " +
                        "utm_source_platform=clidPlatform, ved=0CAcQ_AUoAg, xclid=xcidxxxx, " +
                        "tbm=isch, utm_content=content, utm_source=source}",
                uriInfo.getParameters().toString());
