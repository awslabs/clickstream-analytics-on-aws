...
import static software.aws.solution.test.model.ModelV2.toColumnArray;
import static software.aws.solution.test.transformer.MaxLengthTransformerV2.runMaxLengthTransformerForSession;
import static software.aws.solution.test.transformer.MaxLengthTransformerV2.runMaxLengthTransformerForUserV2;
import static software.aws.solution.test.util.ContextUtil.DEBUG_LOCAL_PROP;
import static software.aws.solution.test.util.DatasetUtil.EVENT_SESSION_START;
import static software.aws.solution.test.util.DatasetUtil.addSchemaToMap;
import static software.aws.solution.test.util.DatasetUtil.hasColumn;
import static software.aws.solution.test.util.DatasetUtil.readDatasetFromPath;
import static software.aws.solution.test.util.DatasetUtil.saveFullDatasetToPath;
import static software.aws.solution.test.util.DatasetUtil.saveIncrementalDatasetToPath;

@Slf4j
public abstract class BaseThirdPartyTransformer extends BaseTransformerV3 {
    ...
    public Map<TableName, Dataset<Row>> transform(final Dataset<Row> dataset) {
        ...
        Dataset<Row> convertedDataset = getDatasetTransformer().transform(datasetWithFileName);
