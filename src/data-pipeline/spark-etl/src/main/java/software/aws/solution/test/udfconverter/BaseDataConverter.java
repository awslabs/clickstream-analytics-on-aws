...
import software.aws.solution.test.transformer.AppRuleConfigurable;
...
import static software.aws.solution.test.util.DatasetUtil.DATA;
import static software.aws.solution.test.util.DatasetUtil.DATA_OUT;
