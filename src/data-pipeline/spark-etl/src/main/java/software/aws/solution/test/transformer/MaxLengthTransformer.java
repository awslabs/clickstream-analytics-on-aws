...
import static software.aws.solution.test.util.ContextUtil.getJobName;
import static software.aws.solution.test.util.DatasetUtil.APP_ID;
import static software.aws.solution.test.util.DatasetUtil.APP_INFO;
import static software.aws.solution.test.util.DatasetUtil.CHANNEL;
import static software.aws.solution.test.util.DatasetUtil.EVENT_DATE;
import static software.aws.solution.test.util.DatasetUtil.EVENT_ID;
import static software.aws.solution.test.util.DatasetUtil.EVENT_NAME;
import static software.aws.solution.test.util.DatasetUtil.EVENT_PARAM_KEY;
import static software.aws.solution.test.util.DatasetUtil.EVENT_PARAM_STRING_VALUE;
import static software.aws.solution.test.util.DatasetUtil.EVENT_TIMESTAMP;
import static software.aws.solution.test.util.DatasetUtil.FIRST_REFERER;
import static software.aws.solution.test.util.DatasetUtil.FIRST_TRAFFIC_MEDIUM;
import static software.aws.solution.test.util.DatasetUtil.FIRST_TRAFFIC_SOURCE;
import static software.aws.solution.test.util.DatasetUtil.FIRST_TRAFFIC_SOURCE_TYPE;
import static software.aws.solution.test.util.DatasetUtil.ID;
import static software.aws.solution.test.util.DatasetUtil.JOB_NAME_COL;
import static software.aws.solution.test.util.DatasetUtil.MAX_PARAM_STRING_VALUE_LEN;
import static software.aws.solution.test.util.DatasetUtil.MAX_STRING_VALUE_LEN;
import static software.aws.solution.test.util.DatasetUtil.PLATFORM;
import static software.aws.solution.test.util.DatasetUtil.PROPERTIES;
import static software.aws.solution.test.util.DatasetUtil.TRUNCATED;
import static software.aws.solution.test.util.DatasetUtil.USER_ID;
import static software.aws.solution.test.util.DatasetUtil.USER_PSEUDO_ID;
