...
package software.aws.solution.test.udfconverter;
...
import software.aws.solution.test.rowconv.ItemGenericRowConverter;
import software.aws.solution.test.rowconv.UserGenericRowConverter;
...
import static software.aws.solution.test.model.ModelV2.EVENT_TYPE;
import static software.aws.solution.test.model.ModelV2.ITEM_TYPE;
import static software.aws.solution.test.model.ModelV2.USER_TYPE;
import static software.aws.solution.test.rowconv.EventGenericRowConverter.toGenericRow;
import static software.aws.solution.test.util.DatasetUtil.CORRUPT_RECORD;
