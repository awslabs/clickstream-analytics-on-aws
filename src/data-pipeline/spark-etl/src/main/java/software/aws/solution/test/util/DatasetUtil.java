...
package software.aws.solution.test.util;
...
import static software.aws.solution.test.gtm.GTMServerDataTransformer.GTM_PREVIOUS_SESSION_KEEP_DAYS;
import static software.aws.solution.test.gtm.GTMServerDataTransformer.MAX_SN;
