...
class TransformerV3Test extends BaseSparkTest {
    ...
    public void should_transform_event_v2() throws IOException {
        ...
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, testWarehouseDir);
    ...
    public void should_transform_save_state_data_temp_table_v2() throws IOException {
        ...
        String tableName1 = dataDir + "/" + getUserPropsTableName("clickstream") + DatasetUtil.FULL_SUFFIX  + BaseTransformerV3.TABLE_VERSION_SUFFIX_V3;
    ...
    public void should_transform_user_item_with_field_len_gt_255_v2() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_item_with_field_len_gt_255_v2/" + new Date().getTime() + "/");
