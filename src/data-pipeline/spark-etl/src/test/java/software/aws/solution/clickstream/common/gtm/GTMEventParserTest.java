...
public class GTMEventParserTest extends BaseTest {
    ...
    void test_gtm_ingestLineToRow() throws IOException {
        ...
        Assertions.assertEquals(expectedJson, prettyJson(Utils.objectToJsonString(row)));
    }
    ...
    void test_gtm_ingestDataToEvent() throws IOException {
        ...
        Assertions.assertEquals(expectedJson, prettyJson(Utils.objectToJsonString(event)));
    }
    ...
    void test_gtm_parseLineToDBRow_event() throws IOException {
        ...
        Assertions.assertEquals(expectedJson, prettyJson(Utils.objectToJsonString(csEvent)), "test_gtm_parseLineToDBRow_event");
    }
    ...
    void test_gtm_parseLineToDBRow_user() throws IOException {
        ...
        Assertions.assertEquals(expectedJson, prettyJson(Utils.objectToJsonString(csUser)), "test_gtm_parseLineToDBRow_user");
    }
    ...
    void test_gtm_parseLineToDBRow_item2() throws IOException {
        ...
        Assertions.assertEquals(expectedJson, prettyJson(Utils.objectToJsonString(csItem)), "test_gtm_parseLineToDBRow_item2");
