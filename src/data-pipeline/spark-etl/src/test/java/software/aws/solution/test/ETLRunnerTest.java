...
class ETLRunnerTest extends ETLRunnerBaseTest {
    ...
    public void should_executeTransformers() throws IOException {
        ...
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.APP_IDS_PROP, "id1,id2,uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "projectId1");
        System.setProperty(ContextUtil.SAVE_INFO_TO_WAREHOUSE_PROP, "true");
        ...
        runner.writeResult(outPath, dataset, TableName.ODS_EVENTS);
    ...
    public void should_executeTransformers_with_TransformerV2_1() throws IOException {
        ...
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_1");
    ...
    public void should_executeTransformers_with_TransformerV2_2() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_2");
    ...
    public void should_executeTransformers_with_TransformerV2_3() throws IOException {
        ...
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_3");
        ...
        String tableName1 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_TRAFFIC_SOURCE + DatasetUtil.INCREMENTAL_SUFFIX + DatasetUtil.TABLE_VERSION_SUFFIX_V1;
        String tableName2 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_DEVICE_ID + DatasetUtil.INCREMENTAL_SUFFIX + DatasetUtil.TABLE_VERSION_SUFFIX_V1;
        String tableName3 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_PAGE_REFERER + DatasetUtil.INCREMENTAL_SUFFIX + DatasetUtil.TABLE_VERSION_SUFFIX_V1;
        String tableName4 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_CHANNEL + DatasetUtil.INCREMENTAL_SUFFIX + DatasetUtil.TABLE_VERSION_SUFFIX_V1;
    ...
    public void should_executeTransformers_with_TransformerV2_user_item_params() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_user_item_params");
        ...
        Dataset<Row> eventParamDataset = spark.read().json(outputPath + TableName.EVEN_PARAMETER.getTableName());
        ...
        Dataset<Row> userDataset = spark.read().json(outputPath + TableName.USER.getTableName());
        ...
        Dataset<Row> itemDataset = spark.read().json(outputPath + TableName.ITEM.getTableName());
        ...
        Dataset<Row> eventDataset = spark.read().json(outputPath + TableName.EVENT.getTableName());
    ...
    public void should_executeTransformers_with_TransformerV2_with_empty_user() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty("force.merge", "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_with_empty_user");
        ...
        Dataset<Row> itemDataset = spark.read().json(outputPath + TableName.ITEM.getTableName());
        try {
            spark.read().json(outputPath + TableName.USER.getTableName());
        } catch (Exception e) {
    ...
    public void should_executeTransformers_with_TransformerV2_with_empty_user_and_item() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty("force.merge", "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/TransformerV2_with_empty_user_and_item");
        ...
        try {
            spark.read().json(outputPath + TableName.ITEM.getTableName());
        } catch (Exception e) {
            Assertions.assertTrue(e.getMessage().contains("Path does not exist"));
        }
        Assertions.assertEquals(1, eventDataset.count());
    ...
    public void should_executeTransformers_with_GTM_server_transformer() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty("force.merge", "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/etl_runner/should_executeTransformers_with_GTM_server_transformer");
        spark.sparkContext().addFile(requireNonNull(getClass().getResource("/GeoLite2-City.mmdb")).getPath());
