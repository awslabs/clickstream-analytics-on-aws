...
import static software.aws.solution.test.util.ContextUtil.*;
...
class ETLRunnerForTransformerV3Test extends ETLRunnerBaseTest {
    ...
    public void should_executeTransformers_with_TransformerV3_1() throws IOException {
        ...
        assertEquals(expectedJson, replaceDynData(dataset.first().prettyJson()));
    ...
    public void should_executeTransformers_with_TransformerV3_2() throws IOException {
        ...
        String tableNameIncr = dataDir + "/" + "etl_clickstream_user_props" + DatasetUtil.INCREMENTAL_SUFFIX + BaseTransformerV3.TABLE_VERSION_SUFFIX_V3;
        String tableNameFull = dataDir + "/" + "etl_clickstream_user_props" + DatasetUtil.FULL_SUFFIX + BaseTransformerV3.TABLE_VERSION_SUFFIX_V3;
