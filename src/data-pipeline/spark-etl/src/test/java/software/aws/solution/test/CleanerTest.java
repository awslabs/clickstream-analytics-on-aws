...
class CleanerTest extends BaseSparkTest {
    ...
    public void should_clean_normal_data() {
        ...
        System.setProperty(ContextUtil.SAVE_INFO_TO_WAREHOUSE_PROP, "false");
    ...
    public void should_clean_when_data_has_corrupt_records() {
        ...
        System.setProperty(ContextUtil.JOB_DATA_DIR_PROP, path);
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
    ...
    public void should_clean_future_event_time_data() {
        ...
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.APP_IDS_PROP, "test-clean-future");
        System.setProperty(ContextUtil.SAVE_INFO_TO_WAREHOUSE_PROP, "false");
