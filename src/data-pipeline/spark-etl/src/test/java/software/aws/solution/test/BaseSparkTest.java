...
public class BaseSparkTest extends BaseTest {
    ...
    @BeforeEach
    public void init() {
        System.setProperty(ContextUtil.JOB_NAME_PROP, "test-job");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse");
        String dbName = "test_db";
        System.setProperty(ContextUtil.DATABASE_PROP, dbName);
        System.setProperty(ContextUtil.USER_KEEP_DAYS_PROP, String.valueOf(365 * 100));
        System.setProperty(ContextUtil.ITEM_KEEP_DAYS_PROP, String.valueOf(365 * 100));
