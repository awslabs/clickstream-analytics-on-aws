...
public class ServerDataConverterTest extends BaseSparkTest {
    ...
    void test_convert_no_js_client_id() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "testApp");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "gtm_server_demo_https");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "false");
    ...
    void test_convert_session_start() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "testApp");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "sessionStartAppId");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "false");
