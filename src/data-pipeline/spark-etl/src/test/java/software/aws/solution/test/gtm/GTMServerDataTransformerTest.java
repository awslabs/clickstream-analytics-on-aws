...
public class GTMServerDataTransformerTest extends BaseSparkTest {
    ...
    void test_convert_event() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "testApp");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
    ...
    void test_transform_data_item() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/gtm/test_transform_data_item/");
    ...
    void test_transform_data_user() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/gtm/test_transform_data_user/");
    ...
    void test_transform_data_user_login() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/gtm/test_transform_data_user_login/");
    ...
    void test_transform_data_user_login2() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/gtm/test_transform_data_user_login2/");
    ...
    void test_transform_data_with_session_start() throws IOException {
        ...
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_gtm_server");
        System.setProperty(ContextUtil.DEBUG_LOCAL_PROP, "true");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/gtm/test_transform_data_with_session_start/");
