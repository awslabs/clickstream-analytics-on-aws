...
import static software.aws.solution.test.ETLRunner.TRANSFORM_METHOD_NAME;
...
class TransformerV2Test extends BaseSparkTest {
    ...
    public void should_transform_event() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_event/");
    ...
    public void should_transform_event_params() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_event_params/");
    ...
    public void should_transform_items() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_items/");
    ...
    public void should_transform_user() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user/");
    ...
    public void should_transform_user_with_page_referer1() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_with_page_referer1/");
    ...
    public void should_transform_user_with_page_referrer2() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_with_page_referrer2/");
    ...
    public void should_transform_user_ip() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_ip/");
    ...
    public void should_transform_save_state_data_temp_table() throws IOException {
        ...
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_save_state_data_temp_table/");
        ...
        String tableName1 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_TRAFFIC_SOURCE + DatasetUtil.FULL_SUFFIX  + "_v1";;
        String tableName2 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_DEVICE_ID + DatasetUtil.FULL_SUFFIX + "_v1";
        String tableName3 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_PAGE_REFERER + DatasetUtil.FULL_SUFFIX + "_v1";
        String tableName4 = dataDir + "/" + DatasetUtil.TABLE_ETL_USER_CHANNEL + DatasetUtil.FULL_SUFFIX + "_v1";
    ...
    public void should_transform_save_state_data_incremental() throws IOException {
        ...
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_save_state_data_incremental/");
        ...
        String pathUser = dirPath + "/user" + DatasetUtil.INCREMENTAL_SUFFIX + "_v1";
        String pathItem = dirPath + "/item" + DatasetUtil.INCREMENTAL_SUFFIX + "_v1";
    ...
    public void check_return_type() throws ClassNotFoundException, NoSuchMethodException {
        ...
        Class<?> aClass = Class.forName("software.aws.solution.test.TransformerV2");
        ...
        Class<?> aClass1 = Class.forName("software.aws.solution.test.Transformer");
    ...
    public void should_transform_user_with_first_open() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_with_first_open/");
    ...
    public void should_transform_user_with_traffic_source() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "uba-app");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_with_traffic_source/");
    ...
    public void should_transform_user_with_event_app_start() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "appStartTest");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_user_with_event_app_start/");
    ...
    public void should_transform_event_with_field_len_gt_255() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "appLenMax");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_event_with_field_len_gt_255/");
    ...
    public void should_transform_user_item_with_field_len_gt_255() throws IOException {
        ...
        System.setProperty(ContextUtil.APP_IDS_PROP, "maxLenTestItemUser");
        System.setProperty(ContextUtil.PROJECT_ID_PROP, "test_project_id_01");
        System.setProperty(ContextUtil.WAREHOUSE_DIR_PROP, "/tmp/warehouse/should_transform_event_with_field_len_gt_255/" + new Date().getTime() + "/");
