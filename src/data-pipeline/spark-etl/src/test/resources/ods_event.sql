CREATE EXTERNAL TABLE `ods_events`(
  ...
  `device` struct<mobile_brand_name:string,mobile_model_name:string,manufacturer:string,screen_width:bigint,screen_height:bigint,carrier:string,network_type:string,operating_system_version:string,operating_system:string,ua_browser:string,ua_browser_version:string,ua_os:string,ua_os_version:string,ua_device:string,ua_device_category:string,system_language:string,time_zone_offset_seconds:bigint,vendor_id:string,advertising_id:string,host_name:string,viewport_width:bigint,viewport_height:bigint>,
  ...
  `items` array<struct<brand:string,category:string,category2:string,category3:string,category4:string,category5:string,creative_name:string,creative_slot:string,id:string,location_id:string,name:string,price:double,currency:string,quantity:int>>,
  `platform` string, 
