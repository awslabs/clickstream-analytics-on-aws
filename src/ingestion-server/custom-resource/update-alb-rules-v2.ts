...
export function updateAlbRulesCustomResourceV2(
  ...
  const fn = createUpdateAlbRulesLambda(scope, props.authenticationSecretArn);
...
function createUpdateAlbRulesLambda(scope: Construct, inputAuthenticationSecretArn?: string): SolutionNodejsFunction {
