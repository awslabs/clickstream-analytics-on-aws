  ...
  const vpcEndpoints = [
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.error`,
    ...
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.emr-serverless`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
    ...
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.states`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.logs`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.redshift-data`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.sts`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.ecr.dkr`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.ecr.api`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.ecs`,
      VpcEndpointType: VpcEndpointType.Interface,
    ...
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.ecs-agent`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.ecs-telemetry`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    {
      ...
      ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.kinesis-streams`,
      VpcEndpointType: VpcEndpointType.Interface,
      Groups: vpcEndpointsGroups,
      SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
    },
    ...
    mockVpcEndpoints = [
      {
        ...
        ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.s3`,
      ...
      },
      {
        ...
        ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.dynamodb`,
        VpcEndpointType: VpcEndpointType.Gateway,
        Groups: vpcEndpointsGroups,
        SubnetIds: defaultSubnets.map(subnet => subnet.SubnetId),
      },
      {
        ...
        ServiceName: `com.amazonaws.${props?.bucket?.location ?? 'ap-southeast-1'}.glue`,
        VpcEndpointType: VpcEndpointType.Interface,
