    ...
    with
      ...
      joined_base_data as (
        ...
        where
          ...
          and TIMESTAMP 'epoch' + target_data.event_timestamp / 1000 * INTERVAL '1 second' >= date '2023-10-01'
      ),
      model_base_data as (
        select
          user_pseudo_id,
    ...
    with
      ...
      joined_base_data as (
        ...
        from
          ...
          and target_data.event_timestamp >= touch_point_data_3.event_timestamp
          and (
            target_data.event_timestamp - touch_point_data_3.event_timestamp <= 3600 * 60 * 1000
          )
        where
          touch_point_data_3.event_name <> 'purchase'
      ),
      ...
      total_count_data as (
        ...
        from
          touch_point_data_3
          join shop.user_m_view as u on touch_point_data_3.user_pseudo_id = u.user_pseudo_id
        group by
          event_name
      ),
      model_data_with_user as (
        ...
        from
          model_data
          join shop.user_m_view as u on model_data.user_pseudo_id = u.user_pseudo_id
      ),
      attribution_data as (
        select
          t_event_name,
  ...
  test('first touch model - sum value', () => {
    ...
    with
      ...
      joined_base_data as (
        ...
        where
          touch_point_data_3.event_name <> 'purchase'
          and TIMESTAMP 'epoch' + target_data.event_timestamp / 1000 * INTERVAL '1 second' >= date_trunc('month', current_date - interval '23 months')
      ),
      model_base_data as (
        select
          user_pseudo_id,
  ...
  test('linear model - event count', () => {
    ...
    with
      ...
      joined_base_data as (
        ...
        where
          touch_point_data_3.event_name <> 'purchase'
          and TIMESTAMP 'epoch' + target_data.event_timestamp / 1000 * INTERVAL '1 second' >= date '2023-09-30'
      ),
      model_base_data as (
        select
          user_pseudo_id,
  ...
  test('position model - sum value', () => {
    ...
    with
      ...
      joined_base_data as (
        ...
        where
          touch_point_data_3.event_name <> 'purchase'
          and TIMESTAMP 'epoch' + target_data.event_timestamp / 1000 * INTERVAL '1 second' >= date_trunc('month', current_date - interval '19 months')
      ),
      model_base_data as (
        select
          user_pseudo_id,
    ...
    with
      ...
      joined_base_data as (
        ...
        from
          ...
          and target_data.event_timestamp >= touch_point_data_3.event_timestamp
          and (
            target_data.event_timestamp - touch_point_data_3.event_timestamp <= 604800 * cast(1000 as bigint)
          )
        where
          touch_point_data_3.event_name <> 'purchase'
          and TIMESTAMP 'epoch' + target_data.event_timestamp / 1000 * INTERVAL '1 second' >= date_trunc('week', current_date - interval '3 weeks')
      ),
      model_base_data as (
        select
          user_pseudo_id,
    ...
    with
        ...
        event_base as (
          ...
          from
            shop.event as event
          where
            event.event_date >= DATEADD (day, -620, CURRENT_DATE)
            and event.event_date <= CURRENT_DATE
            and event.event_name in ('view_item', 'add_to_cart', 'purchase')
        ),
        base_data as (
