...
describe('SQL Builder test', () => {
  ...
  test('node path analysis view - id as filter', () => {
  ...
  test('retention view - id as filter', () => {
    ...
    first_table_1 as (
      ...
      where
        event_name = 'add_button_click'
        and (user_pseudo_id = '123123123123')
    ),
    second_table_1 as (
      select
        event_date,
      ...
      where
        ...
        and (
          device_screen_height > 1400
          or user_pseudo_id = '123123123123'
        )
    ),
    result_table as (
      select
  ...
  test('buildFunnelView - id as filter', () => {
          ...
          and (
            ...
            or (
              ...
              and (
                ...
                and _user_first_touch_timestamp > 1686532526770
                and _session_duration > 200
                and user_pseudo_id = 'bbbbbbbbbbbbb'
              )
            )
          )
      ),
  ...
  test('buildFunnelTableView - id as filter', () => {
  ...
  test('buildEventPathAnalysisView - id as filter', () => {
