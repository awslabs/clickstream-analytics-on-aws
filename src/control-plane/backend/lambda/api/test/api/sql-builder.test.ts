...
describe('SQL Builder test', () => {
    ...
    with
      base_data as (
        ...
        where
          ...
          and (
            (event.event_name = 'add_button_click')
            or (event.event_name = 'note_share')
            or (event.event_name = 'note_export')
          )
      ),
      table_0 as (
        select
    ...
    with
      base_data as (
        ...
        where
          ...
          and (
            ...
            or (event.event_name = 'note_export')
            or (
              event.event_name not in ('add_button_click', 'note_share', 'note_export')
            )
          )
      ),
      mid_table_1 as (
      ...
      mid_table_2 as (
        select
          event.event_date,
          event.event_id,
          max(event_param.event_parameter_value) as _session_id
        from
          app1.ods_events as event
      ...
      mid_table as (
        ...
        from
          mid_table_1
          join mid_table_2 on mid_table_1.event_date = mid_table_2.event_date
          and mid_table_1.event_id = mid_table_2.event_id
      ),
      data as (
        select
          *,
    ...
    with
      ...
      mid_table_3 as (
        ...
        where
          ...
          and event_param.event_parameter_key = '_screen_name'
        group by
          1,
          2
      ),
      mid_table as (
        ...
        from
          ...
          join mid_table_2 on mid_table_1.event_date = mid_table_2.event_date
          and mid_table_1.event_id = mid_table_2.event_id
          join mid_table_3 on mid_table_1.event_date = mid_table_3.event_date
          and mid_table_1.event_id = mid_table_3.event_id
      ),
      data as (
        select
          event_name,
    ...
    with
      base_data as (
        ...
        from
          app1.ods_events as event
        where
          event.event_date >= 'Mon Jun 19 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_date <= 'Thu Jun 22 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_name in ('add_button_click', 'note_share', 'note_export')
          and (
            platform = 'Android'
            and device_screen_height <> 1400
      ...
      from
        ...
        join (
          select
            ...
            max(
              case
                when event_parameter_key = '_session_duration' then event_parameter_value
                else null
              end
  ...
  test('_buildCommonPartSql - no condition', () => {
    ...
    const sql2 = format(sql, {
      language: 'postgresql',
    });

    expect(sql2.trim().replace(/ /g, '')).toEqual(`
    with
    base_data as (
      select
        event.event_date,
  ...
  test('_buildCommonPartSql - only user condition', () => {
        ...
        from
          ...
          join (
            select
              ...
              custom_attr_value
            from
              app1.clickstream_user_attr_view
          ) as user_param on event.user_pseudo_id = user_param.user_pseudo_id
        where
          event.event_date >= 'Sun Apr 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_date <= 'Fri Jun 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_name in ('add_button_click', 'note_share', 'note_export')
          and (
            (
              ...
              and (
                ...
                and (
                  custom_attr_key = '_user_first_touch_timestamp'
                  and custom_attr_value > '1686532526770'
                )
              )
            )
            or (event.event_name = 'note_share')
  ...
  test('_buildCommonPartSql - global condition - only user condition', () => {
  ...
  test('_buildCommonPartSql - simple', () => {
      ...
      base_data as (
        ...
        from
          ...
          join (
            ...
            from
              app1.clickstream_ods_events_parameter_view
            where
          ...
          ) as event_param on event.event_date = event_param.event_date
          and event.event_id = event_param.event_id
        where
          event.event_date >= 'Sun Apr 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_date <= 'Fri Jun 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          ...
          and (
            ...
            or (event.event_name = 'note_share')
            or (
              event.event_name = 'note_export'
              and (
                platform = 'Android'
                and geo_country = 'China'
                and (
                  event_parameter_key = '_session_duration'
                  and event_parameter_value > '200'
                )
              )
            )
          )
  ...
  test('buildEventPathAnalysisView - simple condition', () => {
  ...
  test('buildRetentionAnalysisView', () => {
    ...
    const sql = buildRetentionAnalysisView({
      ...
      timeScopeType: ExploreTimeScopeType.FIXED,
      timeStart: new Date('2023-08-01'),
      timeEnd: new Date('2023-08-07'),
      groupColumn: ExploreGroupColumn.DAY,
    });
    ...
    with
        ...
        from
          (
            ...
            from
              app1.ods_events as event
            where
              event.event_date >= 'Tue Aug 01 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
              and event.event_date <= 'Mon Aug 07 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
      ...
      date_list as (
        select
          '2023-08-02'::date as event_date
        union all
        select
          '2023-08-03'::date as event_date
        union all
        select
          '2023-08-04'::date as event_date
        union all
        select
          '2023-08-05'::date as event_date
        union all
        select
          '2023-08-06'::date as event_date
        union all
        select
          '2023-08-07'::date as event_date
      ),
      first_table_0 as (
        select
          event_date,
  ...
  test('buildRetentionAnalysisView - simple condition', () => {
    ...
    with
      base_data as (
        ...
        where
          event.event_date >= 'Tue Aug 01 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_date <= 'Mon Aug 07 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_name in ('add_button_click', 'note_export')
      ),
      first_date as (
        select
          min(event_date) as first_date
  ...
  test('event analysis sql - group condition - nest param - simple condition', () => {
  ...
  test('event analysis sql - group condition - public param - simple condition', () => {
        ...
        from
          ...
          join (
            ...
            group by
              1,
              2
          ) as groupTable on event.event_date = groupTable.event_date
          and event.event_id = groupTable.event_id
        where
          event.event_date >= 'Sun Apr 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_date <= 'Fri Jun 30 2023 00:00:00 GMT+0000 (Coordinated Universal Time)'
          and event.event_name in ('add_button_click', 'note_share', 'note_export')
  ...
  test('funnel analysis sql - group condition - public param - simple condition', () => {
