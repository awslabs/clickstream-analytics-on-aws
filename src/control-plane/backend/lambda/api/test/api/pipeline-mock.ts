...
export const KINESIS_ETL_NEW_REDSHIFT_PIPELINE_WITH_WORKFLOW_FOR_UPGRADE: IPipeline = {
  ...KINESIS_ETL_NEW_REDSHIFT_PIPELINE,
  status: {
    ...BASE_STATUS,
  },
...
export const KINESIS_ETL_NEW_REDSHIFT_UPDATE_PIPELINE_WITH_WORKFLOW: IPipeline = {
