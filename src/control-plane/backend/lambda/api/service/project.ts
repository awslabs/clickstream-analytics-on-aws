...
import { CreateProjectRequest, CreateProjectResponse, DeleteProjectRequest, GetProjectRequest, GetProjectResponse, IProject, ListProjectsRequest, ListProjectsResponse, UpdateProjectRequest, VerificationProjectRequest, VerificationProjectResponse } from '../common/clickstream-types';
