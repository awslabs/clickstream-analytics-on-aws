...
import { ListDashboardsRequest, ListDashboardsResponse, IDashboard, CreateDashboardRequest, CreateDashboardResponse, DescribeDashboardRequest, DescribeDashboardResponse, DeleteDashboardRequest, DescribeAnalyzesRequest, DescribeAnalyzesResponse } from '../common/clickstream-types';
import { DEFAULT_DASHBOARD_NAME, OUTPUT_REPORTING_QUICKSIGHT_DATA_SOURCE_ARN, OUTPUT_REPORT_DASHBOARDS_SUFFIX } from '../common/constants-ln';
