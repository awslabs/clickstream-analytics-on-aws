...
import { CreateUserRequest, CreateUserResponse, DeleteUserRequest, GetUserRequest, GetUserResponse, GetUserSettingsResponse, IUser, ListUsersRequest, ListUsersResponse, UpdateUserRequest, UpdateUserSettingsRequest } from '../common/clickstream-types';
...
export class UserService {
  ...
  public async add(req: any, res: any, next: any) {
    try {
      ...
      const cUser = new CUser(iUser, res.get('X-Click-Stream-Operator'));
      const id = await cUser.create();
  ...
  public async delete(req: any, res: any, next: any) {
    try {
      ...
      const cUser = new CUser(user, res.get('X-Click-Stream-Operator'));
      await cUser.delete();
