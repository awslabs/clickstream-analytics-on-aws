...
export const CLICKSTREAM_DEPRECATED_VIEW_LIST = ['clickstream_session_view_v1', 'clickstream_event_view_v1', 'clickstream_lifecycle_daily_view_v1', 'clickstream_lifecycle_weekly_view_v1'];
