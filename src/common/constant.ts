...
export const OUTPUT_DATA_ANALYTICS_REDSHIFT_SERVERLESS_WORKGROUP_NAME =
  'StackCreatedRedshiftServerlessWorkgroupName';
export const OUTPUT_DATA_ANALYTICS_REDSHIFT_SERVERLESS_WORKGROUP_ENDPOINT_ADDRESS =
  'StackCreatedRedshiftServerlessWorkgroupEndpointAddress';
export const OUTPUT_DATA_ANALYTICS_REDSHIFT_SERVERLESS_WORKGROUP_ENDPOINT_PORT =
  'StackCreatedRedshiftServerlessWorkgroupEndpointPort';
export const OUTPUT_DATA_ANALYTICS_REDSHIFT_SERVERLESS_NAMESPACE_NAME =
  'StackCreatedRedshiftServerlessNamespaceName';
export const OUTPUT_DATA_ANALYTICS_REDSHIFT_BI_USER_CREDENTIAL_PARAMETER_SUFFIX =
