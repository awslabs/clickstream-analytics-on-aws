            ...
            'Fn::If':
              [
                'realtimeDashboardCondition',
                {
                  'Fn::GetAtt':
                      [
                        'ClickstreamTemplateDefRealtime',
                        'Arn',
                      ],
                },
                '',
        ...
        dataSets:
          [
            ...
            },
            {
              ...
              useSpice: 'no',
              customSql: "\n        -- clickstream-builtin-dashboard\n        SELECT max(refresh_date) as \"Latest refresh date\" FROM {{schema}}.refresh_mv_sp_status where triggerred_by = 'WORK_FLOW'",
              columns:
                  [
                    {
            ...
            },
            {
              ...
              useSpice: 'no',
              customSql: "\n        -- clickstream-builtin-dashboard\n        SELECT * FROM {{schema}}.clickstream_lifecycle_weekly_view_v3 where time_period >= <<$startDate20>> and time_period < DATEADD(DAY, 1, date_trunc('day', <<$endDate20>>))",
              columns:
                  [
                    {
                      Name: 'time_period',
        ...
        dataSetsSpice:
          [
            ...
            },
            {
              ...
              customSql: '\n        -- clickstream-builtin-dashboard\n        SELECT * FROM {{schema}}.clickstream_lifecycle_weekly_view_v3 ',
              columns:
                  [
                    {
                      Name: 'time_period',
