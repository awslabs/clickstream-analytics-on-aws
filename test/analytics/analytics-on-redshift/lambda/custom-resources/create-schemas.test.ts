...
import { CLICKSTREAM_DEPRECATED_VIEW_LIST } from '../../../../../src/common/constant';
...
describe('Custom resource - Create schemas for applications in Redshift database', () => {
  ...
  const appNewCount = appReportingCount * 2 + appSchemaCount + 7 + CLICKSTREAM_DEPRECATED_VIEW_LIST.length; // total: 42
