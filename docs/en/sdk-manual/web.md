...
| screen_height   | number    | the website window height pixel                                   | generated from `window.innerHeight`                                                                                                                                                                                                                        | data analysis needs                                                                                   |
| screen_width    | number    | the website window width pixel                                    | generated from `window.innerWidth`                                                                                                                                                                                                                         | data analysis needs                                                                                   |
