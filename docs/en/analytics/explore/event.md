...
> Calculate the daily page views (PV - Page View) and active user count (UV - Unique Visitor) on the web from different countries over the past month, requiring active users to have a session duration of at least 30 seconds (i.e., 30000 millisecond), and save it into the 
...
8. Click the **Save to Dashboard** button in the top right corner. In the pop-up dialog, enter:
    ...
    - Choose a Dashboard: Select the previously created `Workshop` dashboard.
    - Choose a Worksheet: Select the previously created `Demo` worksheet.
    - Click **OK**.
