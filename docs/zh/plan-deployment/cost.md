...
| 每日数据量/每秒请求数（RPS） | ALB  | EC2 | NAT(1个)   | 缓冲类型（Buffer type） | 缓冲费用（Buffer cost） | S3   |   总计（USD） |
| ------------------ | --- | --- | ---- | ------------- | ----------- | ---  |  --------- |
| 10RPS             |   7  | 122   | 32 | Kinesis（按需） |    36         |   3   |     200  |
|                   |   7  |  122  | 32 | Kinesis (预备 2 shard)   |      22       |  3   |     186  |
|                   |   7  |  122  | 32 | MSK (m5.large * 2, connector MCU * 1)   |       417      |   3  |     581   |
|                   |   7  |  122  | 32 | 无缓冲              |             |  3    |      164   |
|100RPS             |   43 |  122  | 32 |     Kinesis（按需）              |      86       |  3   |     286 |
|                   | 43    |   122  | 32| Kinesis (预备 2 shard)   |      26       | 3    |     226  |
|           |   43  |  122  | 32|     MSK (m5.large * 2, connector MCU * 1)              |      417       |  3   |     617
|           |   43  |  122 | 32 |     无缓冲              |             |  3    |     200
|1000RPS           |   396  |   122 | 32 |     Kinesis（按需）              |      576       |  14   |    1140 |
|                         |  396   |  122  | 32 | Kinesis (预备 10 shard)   |    146         |   14  |     710  |
|           |  396   | 122  | 32 |     MSK (m5.large * 2, connector MCU * 2~3)              |      530       |  14  |     1094
|           |  396   | 122 | 32  |     无缓冲              |            |  14   |     564

!!! info "Note"
    可通过 [VPC endpoint][vpce] 连接S3/KDS/MSK以节省NAT的费用.
