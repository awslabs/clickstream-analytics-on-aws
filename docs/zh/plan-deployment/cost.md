...
| ----------------------- | --------------------- | -------- | ------------------------ | ------------- | ------------- | ------------- | ----- |
| 10RPS             | 每小时                |     $108（$2.2/GB）    | 无服务器 (基于8个RPU) |     $157          |   $3.4          | $0.36 | $268.76    |
|                         | 每6小时              |     $43.4（$0.88/GB）    | 无服务器 (基于8个RPU)               |       $71   |       $3.4     | $0.36 |  $118.16    |
|                         | 每日                 |      $64.8（$1.32/GB）    | 无服务器 (基于8个RPU)               |     $31     |       $3.4         | $0.36 |  $99.56    |
| 100RPS             | 每小时                |      $933（$1.9/GB）   | 无服务器 (基于8个RPU) |       $424    | $34    | $3.6 | $1394.6    |
|                         | 每6小时              |     $433（$0.88/GB）     | 无服务器 (基于8个RPU)               |       $235      | $34  | $3.6 |  $705.6    |
|                         | 每日                 |     $660（$1.35/GB）     | 无服务器 (基于8个RPU)               |       $134        | $34 | $3.6 |   $831.6   |
| 1000RPS             | 每40分钟（推荐）                |      $4024（$0.82/GB）   | 无服务器 (基于32个RPU) |       $5290     | $340   | $36 | $9690    |
