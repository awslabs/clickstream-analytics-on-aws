...
| ----------------------- | --------------------- | -------- | ------------------------ | ------------- | ------------- | ------------- | ----- |
| 10RPS             | 每小时                |     $66.5（$1.35/GB）    | 无服务器 (基于8个RPU) |     $220          |   $3.4          | $0.36 | $290.26    |
|                         | 每6小时              |     $22.2（$0.45/GB）    | 无服务器 (基于8个RPU)               |       $94   |       $3.4     | $0.36 |  $119.96    |
|                         | 每日                 |      $39（$0.8/GB）    | 无服务器 (基于8个RPU)               |     $49     |       $3.4         | $0.36 |  $91.76    |
| 100RPS             | 每小时                |      $353（$0.72/GB）   | 无服务器 (基于8个RPU) |       $838    | $34    | $3.6 | $1228.6    |
|                         | 每6小时              |     $179（$0.37/GB）     | 无服务器 (基于8个RPU)               |       $415      | $34  | $3.6 |  $631.6    |
|                         | 每日                 |     $247（$0.5/GB）     | 无服务器 (基于8个RPU)               |       $168        | $34 | $3.6 |   $452.6   |
| 1000RPS             | 每小时                |      $1260（$0.26/GB）   | 无服务器 (基于8个RPU) |       $1810     | $340   | $36 | $3446    |
